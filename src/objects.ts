...
export function isCorrect(question: Question, answer: string): boolean {
    ...
    const trimmedLowercaseExpected = question.expected.trim().toLowerCase();
    return trimmedLowercaseAnswer === trimmedLowercaseExpected;
}
...
export function isValid(question: Question, answer: string): boolean {
    if (question.type === "short_answer_question") {
        ...
        return question.options.some((option) => option.trim() === answer);
    } else {
        return false;
    }
}
