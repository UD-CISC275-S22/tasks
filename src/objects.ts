...
export function publishQuestion(question: Question): Question {
    const updatedQuestion: Question = { ...question };
    updatedQuestion.published = !updatedQuestion.published;
    return updatedQuestion;
}
...
export function duplicateQuestion(id: number, oldQuestion: Question): Question {
    const duplicatedQuestion: Question = { ...oldQuestion };
    duplicatedQuestion.name = `Copy of ${oldQuestion.name}`;
    duplicatedQuestion.published = false;
    duplicatedQuestion.id = id;
...
export function addOption(question: Question, newOption: string): Question {
    const updatedQuestion: Question = { ...question };
    const updatedOptions: string[] = question.options
        ? [...question.options]
        : [];
