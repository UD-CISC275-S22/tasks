...
export function isCorrect(question: Question, answer: string): boolean {
    ...
    answer.toLowerCase();
    answer.trim();
    const correct = question.expected == answer ? true : false;
    return correct;
}
...
export function toMarkdown(question: Question): string {
    ...
    const second = question.body;
    const option =
        question.type == "multiple_choice_question"
            ? question.options.map((element: string): string => element + "\n")
            : "";
...
export function publishQuestion(question: Question): Question {
    const publish = question.published == true ? false : true;
    const newQuestion = {
        ...question,
        published: publish
    };
...
export function addOption(question: Question, newOption: string): Question {
    const newQuestion = {
        ...question,
        Option: [...question.options, newOption]
    };
    return newQuestion;
}
