...
export function renameQuestion(question: Question, newName: string): Question {
    const renameQuestion = { ...question, name: newName };
...
export function publishQuestion(question: Question): Question {
    if (question.published === true) {
        const invertPublishedTrue = { ...question, published: false };
        return invertPublishedTrue;
    } else {
        const invertPublishedFalse = { ...question, published: true };
        return invertPublishedFalse;
    }
}
...
export function duplicateQuestion(id: number, oldQuestion: Question): Question {
    const questionName = oldQuestion.name;
    const newQuestionName = "Copy of " + questionName;
