...
export function sumPoints(questions: Question[]): number {
    return questions.reduce((accumulator, currecntValue) => {
        return accumulator + currecntValue.points;
    }, 0);
}
...
export function sumPublishedPoints(questions: Question[]): number {
    ...
    return publishedQuestions.reduce((accumulator, currecntValue) => {
        return accumulator + currecntValue.points;
    }, 0);
}
...
export function editOption(
    ...
    return questions.map((question) => {
        if (question.id === targetId) {
            const updatedOptions = [...question.options]; // Make a copy of the options array
