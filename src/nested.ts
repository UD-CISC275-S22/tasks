...
export function changeQuestionTypeById(
    ...
    return questions.map(question => question.id === targetId ? { ...question, type: newQuestionType, options: newQuestionType !== "multiple_choice_question" ? [] : question.options } : question);
}
